...
ComingSoon.Position = UDim2.new(0.265585989, 0, 0.407239825, 0)
...
UICorner_15.Parent = ComingSoon_11
...
UICorner_21.Parent = OpenSpectate
...
local function FSNJP_fake_script() -- Open.open script 
...
coroutine.wrap(FSNJP_fake_script)()
local function UEGCDMZ_fake_script() -- Main.LocalScript 
	local script = Instance.new('LocalScript', Main)

	script.Parent.Active = true
	script.Parent.Draggable = true
end
coroutine.wrap(UEGCDMZ_fake_script)()
local function KHHGHTJ_fake_script() -- Fly.LocalScript 
...
coroutine.wrap(KHHGHTJ_fake_script)()
local function PWNNKN_fake_script() -- KickYourself.LocalScript 
...
coroutine.wrap(PWNNKN_fake_script)()
local function ULXZ_fake_script() -- Reset.LocalScript 
...
coroutine.wrap(ULXZ_fake_script)()
local function LVUA_fake_script() -- Speedm.LocalScript 
...
coroutine.wrap(LVUA_fake_script)()
local function PSYDM_fake_script() -- Speedt.LocalScript 
...
coroutine.wrap(PSYDM_fake_script)()
local function AKEQVQD_fake_script() -- jumpm.LocalScript 
...
coroutine.wrap(AKEQVQD_fake_script)()
local function OMMEF_fake_script() -- Jumpt.LocalScript 
...
coroutine.wrap(OMMEF_fake_script)()
local function OPMU_fake_script() -- ScrollingFrame.LocalScript 
...
coroutine.wrap(OPMU_fake_script)()
